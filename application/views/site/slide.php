...
<link type="text/css" href="<?php echo base_url() ?>/site/royalslider/royalslider.css" rel="stylesheet">
<link type="text/css" href="<?php echo base_url() ?>/site/royalslider/skins/minimal-white/rs-minimal-white.css" rel="stylesheet">
...
<div id='slide'>
	<div id="img-slide" class="sliderContainer" style='width:580px;'>
		<div id="HomeSlide" class="royalSlider rsMinW">
		    ...
		    <a href="<?php echo $row->link; ?>" target='_blank'  style="visibility: visible; opacity: 1; transition: opacity 400ms ease-in-out 0s;">
