	     ...
	     <div class="box-right">
			    ...
			    <div class="content-box">
			         ...
			         <div class="support">
                    <strong>HariNguyen Duc</strong>				
          <a rel="nofollow" href="ymsgr:sendIM?tuyenht90">
		    <img src="http://opi.yahoo.com/online?u=tuyenht90&amp;m=g&amp;t=2">
	      </a>
	      
	      <p>
	         <img style="margin-bottom:-3px" src="<?php echo public_url(); ?>/site/images/phone.png"> 0349327070	      </p>
	      
		  <p>
			<a rel="nofollow" href="mailto:hoangvantuyencnt@gmail.com">
			    <img style="margin-bottom:-3px" src="<?php echo public_url(); ?>/site/images/email.png"> Email: horribleforwork@gmail.com
		    </a>
		  </p>
		  <p>
