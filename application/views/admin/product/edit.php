					...
					<div class="formRow">
						...
						<div class="formRight">
							<div class="left">
								...
								<img src=" <?php echo base_url('upload/product/'.$product->image_link); ?>" alt="placeholder+image"style = "width: 100px; height: 70px;">
							</div>
												...
												<?php if(count($row->subs) > 1): ?>	
									      			<optgroup label="<?php echo $row->name; ?>">
									      				<?php foreach($row->subs as $sub): ?>
									               		 <option value="<?php echo $sub->id; ?>"<?php if($row->id == $product->catalog_id) echo 'selected'; ?>><?php echo $sub->name; ?></option>
											       		 <?php endforeach; ?>
											         </optgroup>
												<?php else: ?>
